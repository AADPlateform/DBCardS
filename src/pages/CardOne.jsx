  ...
  return (
    <div className="min-h-screen bg-white font-['Montserrat']  px-6 flex flex-col items-start max-w-md mx-auto">
      ...
      <div className="w-full space-y-6 mb-10">
        <a href="https://wa.me/213556577950" className="flex items-center gap-5 text-base text-gray-800 hover:text-black transition-colors group">
      ...
      <div className="flex justify-start items-center gap-6 w-full mb-6">
        <a href="https://www.facebook.com/axel.achil.1" target="_blank" rel="noopener noreferrer"
          className="text-gray-600 hover:text-[#1877F2] transition-colors">
          <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
          </svg>
        </a>
        <a href="https://www.instagram.com/axizi.jpg/" target="_blank" rel="noopener noreferrer"
      ...
      <div className="w-full space-y-3 mb-10">
        <a
          href="https://wa.me/213556577950" target="_blank" rel="noopener noreferrer"
